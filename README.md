...
[![Build Status](https://travis-ci.org/ropensci/colpluz.svg?branch=master)](https://travis-ci.org/ropensci/colpluz)
[![Build status](https://ci.appveyor.com/api/projects/status/e5q7fi97pl49h7v6?svg=true)](https://ci.appveyor.com/project/sckott/colpluz)
...
```r
devtools::install_github("ropensci/colpluz")
```
